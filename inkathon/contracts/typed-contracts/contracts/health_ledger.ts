...
import { ContractAbi } from '../contract-info/health_ledger';
import QueryMethods from '../query/health_ledger';
import BuildExtrinsicMethods from '../build-extrinsic/health_ledger';
import TxSignAndSendMethods from '../tx-sign-and-send/health_ledger';
import MixedMethods from '../mixed-methods/health_ledger';
import EventsClass from '../events/health_ledger';
