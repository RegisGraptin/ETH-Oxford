...
import { ContractAbi } from '../contract-info/access';
import QueryMethods from '../query/access';
import BuildExtrinsicMethods from '../build-extrinsic/access';
import TxSignAndSendMethods from '../tx-sign-and-send/access';
import MixedMethods from '../mixed-methods/access';
import EventsClass from '../events/access';
